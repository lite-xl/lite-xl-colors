-- inspired by fall (color theme), with more popping colors.
...
style.syntax["comment"] = { common.color "#FF9442FF" }
style.syntax["keyword"] = { common.color "#C2DA64FF" }
...
style.syntax["operator"] = { common.color "#CED9A1FF" } 
